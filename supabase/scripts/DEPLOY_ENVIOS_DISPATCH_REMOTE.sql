-- =============================================================================
-- Deploy manual: Envios (preparador hub-first + cron ofertas)
-- =============================================================================
-- Use quando `supabase db push` falhar por divergência do histórico de migrações
-- (versões só no remoto). Cole no Supabase Dashboard → SQL Editor → Run.
-- Equivale a aplicar:
--   migrations/20260417093000_envios_dispatch_preparer_hub_first.sql
--   migrations/20260417093500_cron_shipment_expired_offers.sql
-- =============================================================================

-- --- 20260417093000_envios_dispatch_preparer_hub_first.sql -------------------
...
-- --- 20260417093500_cron_shipment_expired_offers.sql -------------------------
