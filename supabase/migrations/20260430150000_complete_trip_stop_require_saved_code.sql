-- Exige código de 4 dígitos gravado na parada ou na shipment; não aceita mais código arbitrário quando o esperado está vazio.
...
COMMENT ON FUNCTION public.complete_trip_stop (uuid, text) IS
  'Motorista autenticado conclui parada (trip_stops + efeitos em shipments). Encomenda: exige 4 dígitos salvos na parada ou na shipment.';
