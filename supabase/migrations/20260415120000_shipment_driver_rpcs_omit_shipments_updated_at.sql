-- Ambientes onde `shipments.updated_at` ainda não existe (migração 20260411150000 não aplicada)
-- quebravam as RPCs com "column updated_at does not exist" e a fila de ofertas nunca era gravada.
