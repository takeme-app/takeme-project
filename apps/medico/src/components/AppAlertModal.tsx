...
const styles = StyleSheet.create({
  ...
  box: { width: '100%', maxWidth: 360, backgroundColor: '#FFFFFF', borderRadius: 16, padding: 24 },
  title: { fontSize: 18, fontWeight: '700', color: '#0d0d0d', textAlign: 'center', marginBottom: 8 },
  message: { fontSize: 14, color: '#767676', textAlign: 'center', marginBottom: 24 },
  primary: { paddingVertical: 16, borderRadius: 12, backgroundColor: '#0d0d0d', alignItems: 'center' },
