...
/**
 * Login igual ao do cliente: telefone/email + senha, Continuar, Esqueceu sua senha?, ou, Google e Apple.
 * Integrado ao mesmo Supabase e tabela profiles (perfil de motorista / ambiente médico).
 */
