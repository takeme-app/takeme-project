/**
 * expo run:android com adb reverse na porta do Metro (8081 no motorista; mesmo default do cliente — evite dois Metros ao mesmo tempo).
...
const metroPort = process.env.REACT_NATIVE_PACKAGER_PORT || '8081';
...
// `expo run:android --no-bundler`: o dev client aponta para REACT_NATIVE_PACKAGER_PORT (padrão 8081 neste app).
