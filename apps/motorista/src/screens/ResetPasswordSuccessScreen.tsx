...
export function ResetPasswordSuccessScreen({ navigation }: Props) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('Login')} activeOpacity={0.7} hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }}>
...
const styles = StyleSheet.create({
  ...
  backButton: { alignSelf: 'flex-start', width: 40, height: 40, borderRadius: 20, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center', marginBottom: 32 },
  ...
  message: { fontSize: 18, fontWeight: '700', color: '#000000', textAlign: 'center', paddingHorizontal: 16, marginBottom: 48 },
  loginButton: { width: '100%', backgroundColor: '#000000', paddingVertical: 16, borderRadius: 12, alignItems: 'center' },
