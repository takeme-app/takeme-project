...
const TERMS_PLACEHOLDER = `Termos de Uso — Take Me (Motorista)

Consulte os Termos de Uso completos no app do cliente ou em takeme.app.br.

Ao usar o app do motorista, você concorda com os Termos de Uso e a Política de Privacidade da Take Me.`;
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Text style={styles.body}>{TERMS_PLACEHOLDER}</Text>
      </ScrollView>
    </View>
  );
}
