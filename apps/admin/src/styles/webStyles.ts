...
export const webStyles = {
  ...
  navbarInner: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', maxWidth: 1233 },
  navLogo: { display: 'flex', alignItems: 'center', gap: 0 },
  navTabs: { display: 'flex', flex: '1 1 0', alignItems: 'center', justifyContent: 'center', minWidth: 0, gap: 0, overflow: 'visible' as const },
  navTabGroup: { display: 'flex', alignItems: 'center', justifyContent: 'center', flexWrap: 'nowrap' as const, gap: 0 },
  navTab: {
    display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end',
    height: 48, padding: '14px 12px', cursor: 'pointer', background: 'none', border: 'none',
    fontFamily: 'Inter, sans-serif', fontSize: 14, lineHeight: 1.5, color: '#767676',
    boxSizing: 'border-box' as const,
  } as React.CSSProperties,
